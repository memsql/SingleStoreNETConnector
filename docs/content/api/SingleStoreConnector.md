...
| class [SingleStoreGeography](./SingleStoreConnector/SingleStoreGeography.md) | Represents SingleStore's internal GEOGRAPHY format: https://docs.singlestore.com/managed-service/en/reference/sql-reference/data-types/geospatial-types.html |
| class [SingleStoreGeographyPoint](./SingleStoreConnector/SingleStoreGeographyPoint.md) | Represents SingleStore's internal GEOGRAPHYPOINT format: https://docs.singlestore.com/managed-service/en/reference/sql-reference/data-types/geospatial-types.html |
