# SingleStoreConnectionOpenedConditions enumeration
...
| New | `0x1` | A new physical connection to a SingleStore Server was opened. This value is mutually exclusive with Reset. |
| Reset | `0x2` | An existing pooled connection to a SingleStore Server was reset. This value is mutually exclusive with New. |
