...
public class TypeMapperTests
{
	...
	[InlineData("point", false, 0, DbType.String)]
	[InlineData("linestring", false, 0, DbType.String)]
	[InlineData("polygon", false, 0, DbType.String)]
	[InlineData("geography", false, 0, DbType.String)]
