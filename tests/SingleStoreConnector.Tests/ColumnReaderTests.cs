...
public class ColumnReaderTests
{
	...
	[InlineData("2345-12-31 12:34:56.000001", "2345-12-31T12:34:56.0000010")]
	[InlineData("9999-12-31 23:59:59.999999", "9999-12-31T23:59:59.9999990")]
	public void ParseSingleStoreDateTime(string input, string expected)
	{
		var actual = (SingleStoreDateTime) TextDateTimeColumnReader.ParseDateTime(Encoding.UTF8.GetBytes(input), convertZeroDateTime: false, allowZeroDateTime: true, dateTimeKind: DateTimeKind.Unspecified);
	...
	{
		var mySqlDateTime = (SingleStoreDateTime) TextDateTimeColumnReader.ParseDateTime("0000-00-00"u8, convertZeroDateTime: false, allowZeroDateTime: true, DateTimeKind.Utc);
