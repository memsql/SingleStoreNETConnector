...
internal sealed class Row
{
	...
	public SingleStoreDecimal GetSingleStoreDecimal(int ordinal)
	{
		...
		throw new InvalidCastException($"Can't convert {ResultSet.ColumnDefinitions![ordinal].ColumnType} to SingleStoreDecimal.");
	}
	...
	private void CheckBinaryColumn(int ordinal)
	{
		...
		if ((column.ColumnFlags & ColumnFlags.Binary) == 0 ||
			...
			columnType != ColumnType.Blob && columnType != ColumnType.MediumBlob && columnType != ColumnType.LongBlob && columnType != ColumnType.Vector))
		{
