...
internal interface ICommandPayloadCreator
{
	...
	/// </summary>
	/// <param name="connection">The <see cref="SingleStoreConnection"/> to which the data will be written.</param>
	...
	ValueTask SendCommandPrologueAsync(SingleStoreConnection connection, CommandListPosition commandListPosition, IOBehavior ioBehavior, CancellationToken cancellationToken);
