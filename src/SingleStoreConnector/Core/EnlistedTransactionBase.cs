...
internal abstract class EnlistedTransactionBase(Transaction transaction, SingleStoreConnection connection) : IEnlistmentNotification
{
	// A SingleStoreConnection that holds the ServerSession that was enrolled in the transaction
	public SingleStoreConnection Connection { get; set; } = connection;
