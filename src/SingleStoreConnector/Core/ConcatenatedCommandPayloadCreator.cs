...
internal sealed class ConcatenatedCommandPayloadCreator : ICommandPayloadCreator
{
	...
	public ValueTask SendCommandPrologueAsync(SingleStoreConnection connection, CommandListPosition commandListPosition, IOBehavior ioBehavior, CancellationToken cancellationToken) =>
		default;
