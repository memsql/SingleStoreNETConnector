...
/// <summary>
/// <see cref="ISingleStoreCommand"/> provides an internal abstraction over operations that can be cancelled: <see cref="SingleStoreCommand"/> and <see cref="SingleStoreBatch"/>.
/// </summary>
