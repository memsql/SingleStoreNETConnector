...
internal static partial class Log
{
	...
	[LoggerMessage(EventIds.SessionMadeConnection, LogLevel.Debug, "Session {SessionId} made connection; server version {ServerVersion}; connection ID {ConnectionId}; supports: attributes {SupportsAttributes}, deprecate EOF {SupportsDeprecateEof}, cached metadata {SupportsCachedMetadata}, SSL {SupportsSsl}, session track {SupportsSessionTrack}, pipelining {SupportsPipelining}, query attributes {SupportsQueryAttributes}")]
	public static partial void SessionMadeConnection(ILogger logger, string sessionId, string serverVersion, int connectionId, bool supportsAttributes, bool supportsDeprecateEof, bool supportsCachedMetadata, bool supportsSsl, bool supportsSessionTrack, bool supportsPipelining, bool supportsQueryAttributes);
	...
	public static partial void CouldNotLoadCertificate(ILogger logger, Exception exception, string sessionId, SingleStoreCertificateStoreLocation certificateStoreLocation);
	...
	public static partial void NotUsingRemoteCertificateValidationCallbackDueToSslMode(ILogger logger, string sessionId, SingleStoreSslMode sslMode);
	...
	[LoggerMessage(EventIds.IgnoringExceptionInDisposeAsync, LogLevel.Warning, "Session {SessionId} ignoring exception in SingleStoreDataReader.DisposeAsync. Message: {ExceptionMessage}. CommandText: {CommandText}")]
